...
@section('meta_title', 'Contact us Page')
@section('content')
        ...
        <div class="row">
            ...
            <div class="col-lg-8">
                ...
                <div class="bg-white border border-top-0 p-4 mb-3">
                    ...
                    <h6 class="text-uppercase font-weight-bold mb-3">Query Contact Us</h6>
                    ...
                    <form action="{{ route('addContacts') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="form-row">
                            <div class="col-md-6">
                        ...
                        <div class="form-group">
                            {{-- @if ($message = Session::get('success'))
                               ...
                               <img style="width:100px" src="images/{{ \Session::get('imgupload')}}" />
                            @endif --}}
